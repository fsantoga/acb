...
CREATE TABLE team (
    ...
    acbid VARCHAR(3) UNIQUE NOT NULL,  -- Unique code from ACB.
...
CREATE TABLE game (
    id INTEGER AUTO_INCREMENT PRIMARY KEY,  -- Table autogenerated id
    acbid VARCHAR(255) UNIQUE NOT NULL,  -- ACB game ID.
    ...
    venue TEXT DEFAULT null,  -- Place of the game, stadium
    attendance INTEGER DEFAULT null,  -- Game attendance
    kickoff_time TIMESTAMP DEFAULT null,  -- Kick-off time. In number of seconds since UNIX epoch, UTC timezone.
...
CREATE TABLE actor (
    id INTEGER  AUTO_INCREMENT PRIMARY KEY,  -- Table autogenerated id
    acbid VARCHAR(255) NOT NULL,  -- ACB player / coach ID.
    is_coach BOOLEAN DEFAULT null,
    display_name VARCHAR(255) DEFAULT null,
    full_name VARCHAR(255) DEFAULT null,
    nationality VARCHAR(255) DEFAULT null,
    birthplace VARCHAR(255) DEFAULT null,
    birthdate DATETIME DEFAULT null,  -- Date of birth. In number of seconds since UNIX epoch, UTC timezone.
    position VARCHAR(255) DEFAULT null,  -- simple string
    height REAL DEFAULT null,  -- In meters.
    weight REAL DEFAULT null,  -- In kilograms.
    license TEXT,
    debut_acb TIMESTAMP DEFAULT null,
