...
CREATE TABLE player (
    id INTEGER  AUTO_INCREMENT PRIMARY KEY,  -- Table autogenerated id
    player_acbid VARCHAR(255) NOT NULL,  -- ACB player / coach ID.
...
CREATE TABLE coach (
    id INTEGER  AUTO_INCREMENT PRIMARY KEY,  -- Table autogenerated id
    coach_acbid VARCHAR(255) NOT NULL,  -- ACB player / coach ID.
    display_name VARCHAR(255) DEFAULT null,
    full_name VARCHAR(255) DEFAULT null,
    nationality VARCHAR(255) DEFAULT null,
    birth_place VARCHAR(255) DEFAULT null,
...
CREATE INDEX coachPerformance_game_id_idx ON coachPerformance(game_id);
CREATE INDEX coachPerformance_team_id_idx ON coachPerformance(team_id);
CREATE INDEX coachPerformance_coach_id_idx ON coachPerformance(coach_id);
...
CREATE INDEX playerPerformance_game_id_idx ON playerPerformance(game_id);
CREATE INDEX playerPerformance_team_id_idx ON playerPerformance(team_id);
CREATE INDEX playerPerformance_player_id_idx ON playerPerformance(player_id);
